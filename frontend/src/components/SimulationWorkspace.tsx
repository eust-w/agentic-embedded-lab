...
export function SimulationWorkspace() {
  ...
  return <section className="simulation-workspace">
    ...
    <div className="simulation-grid">
      ...
      <section className="plots-panel"><header><strong className="active">原始结果</strong><span>仅显示Evidence Bundle中存在的产物</span></header><div className="empty-live-state">当前Bundle未提供可直接绘制的采样序列；请从证据产物读取原始波形或时间序列。</div></section>
    </div>
